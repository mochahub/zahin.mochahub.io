export const cards = [
    ...
    },
    {
        ...
        "start": '2019-09-01',
        "end" : '2019-12-30',
        "desc" : `[Lumina](https://www.lumina.app/) is a portfolio management software for digital assets. At Lumina I assisted with implementing new cryptocurrency exchanges / blockchain explorers into the product. An integration included being able to scrape all of a users transaction history, a users account details and lastly the instruments supported along with their historical prices.
    ...
    },
    {
        ...
        "start": '2019-01-01',
        "end" : '2019-04-30',
        "desc" : `[Aterica](https://www.aterica.com/) is the creator of the \`Veta Smart Case\` and app, which is a smart epi-pen case. 
        At Aterica, I worked on the backend development team and assisted in fixing bugs and adding additional infrastructure logging. 
        My favorite feature that I helped develop was a geo-fence feature that would alert a user if they walked outside of range of their epi-pen.
