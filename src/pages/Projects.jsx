...
export default class Projects extends Component {
      ...
      if (i === 0) {
        chips.push(
          <Chip
            ...
            label={card.tags[i]}
            color="primary"
            style={{ marginRight: "4px", padding: "0px" }}
          />
        );
  ...
  createCard(card) {
    return (
      <Col
        xs={12}
        lg={4}
        style={{ paddingBottom: "5vh", paddingRight: "0", paddingLeft: "0" }}
      >
        <Card
          style={{
            borderRadius: "16px",
        ...
        >
          <CardActionArea>
            ...
            <CardContent>
              ...
              >
                <ReactMarkdown source={card.desc} escapeHtml={false} />
              </Typography>
  ...
  createRows() {
    var rows = [];
    for (var i = 0; i < cards.length; i += 3) rows.push(this.createRow(i));
  ...
  render() {
    return (
      <div>
        <Container>{this.createRows()}</Container>
      </div>
    );
  }
}
